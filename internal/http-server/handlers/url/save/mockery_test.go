...
// NewMockURLtextSaver creates a new instance of MockURLtextSaver. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockURLtextSaver(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockURLtextSaver {
...
// MockURLtextSaver is an autogenerated mock type for the URLtextSaver type
type MockURLtextSaver struct {
	mock.Mock
}

type MockURLtextSaver_Expecter struct {
	mock *mock.Mock
}

func (_m *MockURLtextSaver) EXPECT() *MockURLtextSaver_Expecter {
	return &MockURLtextSaver_Expecter{mock: &_m.Mock}
}

// SaveURL provides a mock function for the type MockURLtextSaver
func (_mock *MockURLtextSaver) SaveURL(URL string, alias string) error {
...
// MockURLtextSaver_SaveURL_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SaveURL'
type MockURLtextSaver_SaveURL_Call struct {
	*mock.Call
}
...
//   - URL string
//   - alias string
func (_e *MockURLtextSaver_Expecter) SaveURL(URL interface{}, alias interface{}) *MockURLtextSaver_SaveURL_Call {
	return &MockURLtextSaver_SaveURL_Call{Call: _e.mock.On("SaveURL", URL, alias)}
}

func (_c *MockURLtextSaver_SaveURL_Call) Run(run func(URL string, alias string)) *MockURLtextSaver_SaveURL_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *MockURLtextSaver_SaveURL_Call) Return(err error) *MockURLtextSaver_SaveURL_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockURLtextSaver_SaveURL_Call) RunAndReturn(run func(URL string, alias string) error) *MockURLtextSaver_SaveURL_Call {
	_c.Call.Return(run)
	return _c
}
